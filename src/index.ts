  ...
  server.registerTool(
    "getAppInfo",
    {
      ...
      inputSchema: {
        ...
        staticValue: z.string().describe(`Static Value with "【${config.hapAppkey}】 / 【${config.hapSign}】", DO NOT Change it. If the value is empty, keep the text style with empty string.`)
      },
      // ⚠️ 不写 outputSchema，避免类型校验输出结构
    },
